...
class SaTOutput: MLFeatureProvider {
    ...
    init(output: MLMultiArray) {
        self.provider = try! MLDictionaryFeatureProvider(dictionary: [
            "output": MLFeatureValue(multiArray: output)
        ])
    }
...
class SaT {
    ...
    class var urlOfModelInThisBundle: URL {
        return Bundle.main.url(
            forResource: "SaT", withExtension: "mlmodelc", subdirectory: "Resources")!
    }
    ...
    */
    convenience init(configuration: MLModelConfiguration = MLModelConfiguration()) throws {
        try self.init(
            contentsOf: type(of: self).urlOfModelInThisBundle, configuration: configuration)
    }
    ...
    */
    class func load(
        ...
        completionHandler handler: @escaping (Swift.Result<SaT, Error>) -> Void
    ) {
        load(
            contentsOf: self.urlOfModelInThisBundle, configuration: configuration,
    ...
    */
    class func load(
        contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(),
        completionHandler handler: @escaping (Swift.Result<SaT, Error>) -> Void
    ) {
    ...
    */
    ...
    /**
        ...
        - returns: the result of the prediction as SaTOutput
    */
    func prediction(input: SaTInput, options: MLPredictionOptions = MLPredictionOptions())
        async throws -> SaTOutput
    {
    ...
    */
    ...
    func prediction(input_ids: MLShapedArray<Int32>, attention_mask: MLShapedArray<Int32>) throws
        -> SaTOutput
    {
        let input_ = SaTInput(input_ids: input_ids, attention_mask: attention_mask)
        return try prediction(input: input_)
    ...
    /**
        ...
        - returns: the result of the prediction as [SaTOutput]
    */
    func predictions(inputs: [SaTInput], options: MLPredictionOptions = MLPredictionOptions())
        throws
        -> [SaTOutput]
    {
