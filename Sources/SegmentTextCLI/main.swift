...
struct Tokenize: AsyncParsableCommand {
    ...
    func run() async throws {
        ...
        guard let modelURL = Bundle.module.url(forResource: "sentencepiece.bpe", withExtension: "model", subdirectory: "Resources") else {
        ...
        */
        ...
        print("CLS token ID: \(clsToken)")
        print("SEP token ID: \(sepToken)")
        print("PAD token ID: \(padToken)")
...
struct Split: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        discussion: "This command uses the CoreML model to identify sentence boundaries and split text."
    )
    ...
    func run() async throws {
        if #available(macOS 15.0, iOS 18.0, tvOS 18.0, watchOS 11.0, visionOS 2.0, *) {
            ...
            print("Found \(sentences.count) sentences:")
...
struct VerifySplitter: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        discussion: "This command runs various test cases through the sentence splitter to verify its functionality."
    )
